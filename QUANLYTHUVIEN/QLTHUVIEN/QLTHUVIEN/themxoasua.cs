...
namespace QLTHUVIEN
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-P51VN0R;Initial Catalog=QLTV;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
